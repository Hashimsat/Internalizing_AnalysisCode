...
(r_EE, p_EE, dof_EE, n1_EE, n2_EE, median_EE_Low,
 median_EE_Low_iqr, median_EE_High, median_EE_High_iqr) = plot_descriptive_boxplots(df_EE_merged_LowHighAnx,
                                                                                    x='G_Category',
                                                                                    y='EE', ax=ax1, title=True,
                                                                                    fontsize=fontsize,
                                                                                    xlabel='General Factor',
                                                                                    ylabel='Estimation Error',
                                                                                    min_val=20, stat='ttest_ind')
...
r_EE_reg, p_EE_reg, t_EE_reg = plot_x_vs_y_FactorScores_robust(df_EE_merged, 'g', 'EE', ax2, title=True, tstat=True,
                                                               fontsize=fontsize, color_index=-2,
...
(r_LR, p_LR, dof_LR, n1_LR, n2_LR, median_LR_Low,
 median_LR_Low_iqr, median_LR_High, median_LR_High_iqr) = plot_descriptive_boxplots(df_LR_merged_LowHighAnx,
                                                                                    x='G_Category',
                                                                                    y='LR', ax=ax3, title=True,
                                                                                    fontsize=fontsize,
                                                                                    xlabel='General Factor',
...
(r_pers, p_pers, dof_pers, n1_pers, n2_pers, median_pers_Low,
 median_pers_Low_iqr, median_pers_High, median_pers_High_iqr) = plot_descriptive_boxplots(df_pers_merged_LowHighAnx,
                                                                                          x='G_Category',
                                                                                          y='Pers', ax=ax5, title=True,
                                                                                          fontsize=fontsize,
                                                                                          xlabel='General Factor',
                                                                                          ylabel='Perseveration Probability',
                                                                                          min_val=-0.1, max_val=1,
                                                                                          stat='ttest_ind')
...
(r_rt, p_rt, dof_rt, n1_rt, n2_rt, median_rt_Low,
 median_rt_Low_iqr, median_rt_High, median_rt_High_iqr) = plot_descriptive_boxplots(df_RT_merged_LowHighAnx,
                                                                                    x='G_Category',
                                                                                    y='RT', ax=ax6, title=True,
                                                                                    fontsize=fontsize,
                                                                                    xlabel='General Factor',
                                                                                    ylabel='Reaction Time (ms)',
                                                                                    min_val=100, max_val=1600,
                                                                                    stat='ttest_ind')
...
stats = {
    'Statistic': ['t_EE_lowhigh', 'p_EE_lowhigh', 'n_Low', 'n_High', 'dof_EE', 'median_EE_Low', 'median_EE_Low_IQIlow',
                  'median_EE_Low_IQIhigh', 'median_EE_High', 'median_EE_High_IQIlow', 'median_EE_High_IQIhigh',
                  't_LR_lowhigh', 'p_LR_lowhigh', 'dof_LR', 'median_LR_Low', 'median_LR_Low_IQIlow',
                  'median_LR_Low_IQIhigh', 'median_LR_High', 'median_LR_High_IQIlow', 'median_LR_High_IQIhigh',
                  't_pers_lowhigh', 'p_pers_lowhigh', 'dof_pers', 'median_pers_Low', 'median_pers_Low_IQIlow',
                  'median_pers_Low_IQIhigh', 'median_pers_High', 'median_pers_High_IQIlow', 'median_pers_High_IQIhigh',
                  't_rt_lowhigh', 'p_rt_lowhigh', 'dof_rt', 'median_rt_Low', 'median_rt_Low_IQIlow',
                  'median_rt_Low_IQIhigh', 'median_rt_High', 'median_rt_High_IQIlow', 'median_rt_High_IQIhigh'],

    'Values': [r_EE, round(p_EE, 2), n1_EE, n2_EE, dof_EE, median_EE_Low, median_EE_Low_iqr[0], median_EE_Low_iqr[1],
               median_EE_High, median_EE_High_iqr[0], median_EE_High_iqr[1],
               r_LR, round(p_LR, 2), dof_LR, median_LR_Low, median_LR_Low_iqr[0], median_LR_Low_iqr[1], median_LR_High,
               median_LR_High_iqr[0], median_LR_High_iqr[1],
               r_pers, round(p_pers, 2), dof_pers, median_pers_Low, median_pers_Low_iqr[0], median_pers_Low_iqr[1],
               median_pers_High, median_pers_High_iqr[0], median_pers_High_iqr[1],
               r_rt, round(p_rt, 2), dof_rt, median_rt_Low, median_rt_Low_iqr[0], median_rt_Low_iqr[1], median_rt_High,
               median_rt_High_iqr[0], median_rt_High_iqr[1]],
}
