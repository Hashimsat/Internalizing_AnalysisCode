...
def fit_model(args, params, data):
    """
        ...
        args : argparse.Namespace
            Arguments containing model specifications.
        params : list of str
            List of parameter names to be estimated.
        data : dict
            Dictionary containing the data to fit the model to.
    ...
    with model:
        ...
        print('sampling ...')
        trace = pm.sample(args.steps, step=step, chains=args.num_chains,
                          tune=args.steps_tune, random_seed=args.seed)
