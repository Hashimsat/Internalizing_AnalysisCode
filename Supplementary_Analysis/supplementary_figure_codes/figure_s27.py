# Fig S27: Plot posterior predictive checks for the winning model  for PRL with reward magnitude
# For PPC we show number of switches in stable and volatile blocks and the P(Correct) for each participant simulation
...
model_path = os.path.join(base_dir, 'data/reversal_task/'
                                    'prl_rewardmag_priorstd1_model=9_covariate=Bi3itemCDM_date=2025_1_17'
                                    '_samples=2000_seed=3_exp=3.pkl')
